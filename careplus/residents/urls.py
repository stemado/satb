...
urlpatterns = [
    url(r'^active_medication/(?P<id>[0-9]+)/$', views.active_medications, name='active_medications'),
    url(r'^overdue_medications/(?P<id>[0-9]+)/$', views.overdue_medications, name='overdue_medications'),
