...
import markdown
from careplus.articles.forms import ArticleForm
from careplus.articles.models import Article, ArticleComment, Tag
...
def deleteArticle(request, id):
    article = get_object_or_404(Article, pk=id).delete()
